...
(
    ...
    input  logic                  mshr_alloc_store_i,
...
//  }}}
    ...
    typedef enum {
        ...
        REFILL_INVAL_ACK    // Invalidation is issued via mem intf
    } refill_fsm_e;
...
`endif
    ...
    hpdcache_mshr #(
        ...
        .alloc_inval_i            (mshr_alloc_inval_i),
