        ...
        unique case (cmoh_fsm_q)
            ...
            CMOH_WAIT_MSHR_RTAB_EMPTY: begin
                if (mshr_empty_i && rtab_empty_i && ctrl_empty_i) begin
                    ...
                    end else if (cmoh_op_q.is_flush_by_nline | cmoh_op_q.is_flush_force_inval_by_nline) begin
        ...
        begin : cmoh_flush_req_w_comb
            ...
            if (cmoh_flush_req_valid_q) begin
                unique case (cmoh_fsm_q)
                    ...
                    CMOH_FLUSH_NLINE_NEXT:
                        cmoh_flush_req_w = cmoh_dir_check_nline_hit & (dir_check_nline_dirty_i | cmoh_op_q.is_flush_force_inval_by_nline);
                endcase
            end
        end
