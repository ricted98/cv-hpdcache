...
(
    ...
    input  hpdcache_mshr_op_e      st2_mshr_alloc_op_i,

    output logic                   st2_mshr_alloc_o,
    output logic                   st2_mshr_alloc_cs_o,
    output logic                   st2_mshr_alloc_need_rsp_o,
    output logic                   st2_mshr_alloc_wback_o,
    output hpdcache_mshr_op_e      st2_mshr_alloc_op_o,
    ...
    begin : hpdcache_ctrl_comb
        ...
        st2_mshr_alloc_op_o                 = st2_mshr_alloc_op_i;
                        ...
                        if (!cachedir_hit_i) begin
                            ...
                            //  entry in the MSHR and send the refill request
                                ...
                                st2_mshr_alloc_wback_o = (st1_req_wr_auto_i & cfg_default_wb_i) |
                                                          st1_req_wr_wb_i;
                                st2_mshr_alloc_op_o = HPDCACHE_MSHR_OP_LOAD_REFILL;
                        ...
                        //  {{{
                            ...
                            begin
                                ...
                                //  Flush needed but the controller is not ready
                                    ...
                                    st2_mshr_alloc_op_o = HPDCACHE_MSHR_OP_STORE_REFILL;
                        ...
                        //  {{{
                            ...
                            begin
                                ...
                                if (wbuf_read_hit_i) begin
                                    ...
                                    st2_mshr_alloc_need_rsp_o = 1'b0;
                                    st2_mshr_alloc_wback_o = 1'b1;
                                    st2_mshr_alloc_op_o = HPDCACHE_MSHR_OP_STORE_INVAL;
                                    // Put the request in the replay table
                                    st1_rtab_alloc = 1'b1;
                                    st1_rtab_write_miss_o = 1'b1;
                                    // Actually, this is not a miss!
