...
#define HPDCACHE_CL_OFFSET_WIDTH                                                                   \
    HPDCACHE_TEST_DEFS_LOG2(((HPDCACHE_CL_WORDS) * (HPDCACHE_WORD_WIDTH)) / 8)
...
#define HPDCACHE_CORE_REQ_WIDTH                                                                    \
    ((HPDCACHE_ADDR_OFFSET_WIDTH) + (HPDCACHE_REQ_DATA_WIDTH) + (HPDCACHE_REQ_OP_WIDTH)            \
     + ((HPDCACHE_REQ_DATA_WIDTH) / 8) + (HPDCACHE_REQ_SIZE_WIDTH) + (HPDCACHE_REQ_SRC_ID_WIDTH)   \
     + (HPDCACHE_REQ_TRANS_ID_WIDTH) + (HPDCACHE_REQ_NEED_RSP_WIDTH)                               \
     + (HPDCACHE_REQ_PHYS_INDEXED_WIDTH) + (HPDCACHE_TAG_WIDTH) + (HPDCACHE_REQ_PMA_WIDTH))

#define HPDCACHE_CORE_RSP_WIDTH                                                                    \
    ((HPDCACHE_REQ_DATA_WIDTH) + (HPDCACHE_REQ_SRC_ID_WIDTH) + (HPDCACHE_REQ_TRANS_ID_WIDTH)       \
     + (HPDCACHE_RSP_ERROR_WIDTH) + (HPDCACHE_RSP_ABORTED_WIDTH))

#define HPDCACHE_SNOOP_META_WIDTH 5
